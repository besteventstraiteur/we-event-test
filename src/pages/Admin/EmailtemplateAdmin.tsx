          ...
          <div className="overflow-y-auto max-h-[50vh] space-y-2">
            {templates.map((tpl) => (
              <div
                ...
                className="p-2 border border-borderlight dark:border-neutral-700 hover:border-blue-400 dark:hover:border-neutral-700 hover:bg-neutral-800 rounded-md cursor-pointer transition-all duration-300"
              >
      ...
      <div className="flex-1 p-6 bg-white dark:bg-neutral-800 rounded-lg space-y-4">
        ...
        <div className="items-center  justify-between gap-3 mb-2">
          <div className="flex justify-between">
            ...
            >
              {openEditor && (
                <div className="absolute right-0 z-10 w-full mt-2 bg-white border border-borderlight dark:border-neutral-700 rounded-md shadow-lg">
                  <ul className="py-1 text-sm text-gray-700 max-h-60 overflow-auto">
                    {variableOptions.length === 0 && (
                      <li className="px-4 py-2 text-gray-400">
                        Aucun champ disponible
                  ...
                  {attachments.map((url, idx) => (
                    <li key={idx}>
                      <a
                        ...
                        className="text-sm underline dark:text-neutral-300"
                      >
                        {url.split("/").pop()}
                      </a>
                    </li>
