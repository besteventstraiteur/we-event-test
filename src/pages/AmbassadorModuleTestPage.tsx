...
const AmbassadorModuleTestPage: React.FC = () => {
          ...
          <div className="flex items-center justify-between mb-4">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 mb-2">
                👥 Ambassador Module - Test Page
              </h1>
              <p className="text-gray-600">Programme ambassadeurs</p>
            </div>
            <Link
...
export default AmbassadorModuleTestPage;
