...
const ProviderChat = () => {
  ...
  return (
    <>
      <h1 className="text-2xl font-bold mb-4 hidden md:block">Messages</h1>
          ...
          <div className="h-[calc(100dvh-220px)] overflow-y-auto">
            {conversations.map((c) => (
              <div
                ...
                className="p-3 hover:bg-gray-100 hover:dark:bg-white/5 cursor-pointer"
              >
  ...
  `}
        >
          {activeConversation ? (
            <>
              ...
              <div className="h-[calc(100dvh-220px)] overflow-y-auto p-3">
                {[...messages]
                  .sort(
                    (a, b) =>
      ...
      <OuterModal active={showchatModal} setActive={setShowchatModal}>
        <div className="max-w-lg mx-auto border-2 border-transparent dark:border-[#2F2F2F] rounded-2xl bg-white dark:bg-[#1E1E1E] relative">
          <X
          ...
          <form className="space-y-3">
            <div>
              <InputGroup
                label="Name"
                placeholder="Recherche d’un prestataire"
              />
            </div>
            <div>
              <InputGroup
